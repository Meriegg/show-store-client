...
const Navbar = () => {
  ...
  const { toggleOpen } = useCart((state) => state);
  ...
  return (
    <>
      <div
        className="flex items-center transition-all duration-300 justify-between px-8 md:px-4 py-4 border-b-[1px] border-black sticky top-0 bg-white z-30"
        id="NAVBAR"
      >
